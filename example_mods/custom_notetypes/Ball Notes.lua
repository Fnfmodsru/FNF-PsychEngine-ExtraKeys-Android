function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Ball Notes' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'balls'); --Change texture
